...
![ROC curve:full vs reduced model](pic/ROC_curve_full&reduced.png){width=50%}
...
![Deviance_residuals vs fitted_probabilities](pic/Deviance_residuals&fitted_probabilities.png){width=50%}
