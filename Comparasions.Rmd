---
title: "Comparasion of Logistic Regression, Random Forest, and XGBoost with all predictors"
author: "Group7"
date: "2025-11-30"
output: pdf_document
---
...
# full formula with all 21 predictors
...
# test set prediction
xgb_prob <- predict(xgb_fit, newdata = dtest)  # 0~1
...
** Comparisons between Logistic Regression, Random Forst and XGBoost **
**ROC AUC、Accuracy **
...
```{r}
## ===== Unified evaluation for the three models =====

# make sure we have a common 0/1 outcome on the test set
y_test <- ifelse(test_data$Diabetes_binary == "Diabetes", 1, 0)

# probabilities from each model (you already computed these above)
glm_prob_test <- test_prob_full         # logistic regression
rf_prob_test  <- rf_test_prob           # random forest
xgb_prob_test <- xgb_prob               # XGBoost

## 1. A small helper to compute:
##    - ROC AUC
##    - Accuracy, Sensitivity, Specificity (threshold = 0.5)
##    - Brier score
...
```{r}
# Calibration plots for the three models (test set)
